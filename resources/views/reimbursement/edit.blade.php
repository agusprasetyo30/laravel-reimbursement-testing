			...
			<div class="card-body">
				<form action="{{ route('reimbursement.update', $reimbursement->id) }}" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label>Date</label>
						<input type="text" class="form-control datepicker" name="date" value="{{ $reimbursement->date }}">
					</div>
					<div class="form-group">
						<label>Reimbursement Name <span class="text-danger">*</span></label>
						<input name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $reimbursement->name }}">
					...
					<div class="form-group">
						...
						<div class="row">
							<div class="col-sm-12 col-md-12">
								<textarea class="summernote-simple" name="description">{{ $reimbursement->description }}</textarea>
					...
					<div class="form-group">
						...
						<a href="{{ asset('storage/' . $reimbursement->document_file_path) }}" id="open-file-link" target="_blank" title="Open document in new tab">
